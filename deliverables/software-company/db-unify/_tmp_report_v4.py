...
lines.append("")
lines.append("二、电子病历数据中断占比超过30%的机构有(共 {} 家,按中断率排序):".format(len(rows)))
...
lines.append("电子病历中断>30% 合计 {} 家".format(len(rows)))
...
print(text[:1500])
print("\n...")
print("文件总大小:{} 字符".format(len(text)))
print("已写入:", new)