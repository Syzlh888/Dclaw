...
export const ExportStepOptions: React.FC = () => {
  ...
  return (
    <Box sx={{ pt: 1 }}>
      <Typography
        variant="subtitle2"
        sx={{ mb: 1.5, color: '#E0E0E0', fontSize: 'calc(0.8125rem * var(--dc-scale, 1))', fontWeight: 600, letterSpacing: 0.3 }}
      >
        选项与预览
      </Typography>
      ...
      >
        <TextField
          ...
          sx={{
            width: 160,
            bgcolor: '#3C3F41',
            '& .MuiOutlinedInput-root': { fontSize: 'calc(0.8125rem * var(--dc-scale, 1))' },
            '& .MuiInputLabel-root': { fontSize: 'calc(0.75rem * var(--dc-scale, 1))', color: '#BBBBBB' },
          }}
          helperText={<span style={{ fontSize: 'calc(0.6875rem * var(--dc-scale, 1))', color: '#888' }}>1 - 50000</span>}
        />
        <TextField
          size="small"
          label="最大行数"
          ...
          helperText={
            <span style={{ fontSize: 'calc(0.6875rem * var(--dc-scale, 1))', color: options.maxRows > 0 ? '#FFB74D' : '#888' }}>
        ...
        <Button
          ...
          sx={{
            ...
            minWidth: 130,
            height: 36,
            fontSize: 'calc(0.7812rem * var(--dc-scale, 1))',
            fontWeight: 600,
            textTransform: 'none',
            bgcolor: '#1976D2',
      ...
      <FormControlLabel
        ...
        label={<span style={{ fontSize: 'calc(0.7812rem * var(--dc-scale, 1))', color: '#BBBBBB' }}>包含列标题行</span>}
        sx={{ mb: 2, ml: 0.5 }}
      />
                ...
                {preview.rows.map((row, i) => (
                  <TableRow key={i} hover>
                    {preview.columns.map((c) => (
                      <TableCell
                        key={c}
                        sx={{ color: '#BBBBBB', fontSize: 'calc(0.6875rem * var(--dc-scale, 1))', fontFamily: 'monospace' }}
                      >
                        {row[c] === null
                          ? 'NULL'
